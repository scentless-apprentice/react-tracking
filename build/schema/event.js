...
module.exports = {
  description:
    'The “event” value set with each push into the dataLayer triggers the relevant tracking behavior. * Please note: Each time an event fires. The application should perform a dataLayer.push',

  enumDescription: {
    pageDataReady:
      'This event triggers pageview tracking. It should be sent with the initial      dataLayer push and with any dynamic update that should be tracked as a pageview. ',
    scrollComplete:
      'This event should fire when a user has stopped scrolling for 250ms. It should push new viewport values into the dataLayer. ',
    heartbeat:
  ...
  enum: [
    ...
    /**
     * This event should fire for when a module / card / block comes into view.
     * This should push new values into the corresponding module / card /block object.
     */
    'impression',
    'performance',
    'error',
